...
class LootGrid() {
  ...
  def start(items: js.Array[ComputedItem]) {
    ...
    val columns = js.Array[js.Dynamic](
      ...
      makeColumn("lnk")(_.sockets.map(_.mkString("")).mkString("-")),
      ...
      makeColumn("tRes")(_.plusTo.totalResistance),
      makeColumn("fRes")(_.plusTo.resistance.fire),
      makeColumn("cRes")(_.plusTo.resistance.cold),
      makeColumn("lRes")(_.plusTo.resistance.lightning),
      makeColumn("xRes")(_.plusTo.resistance.chaos),
